...
repo_url = os.getenv('REPO')  # Example: https://github.com/djsasha777/infra.git
branch = os.getenv('BRANCH')
filePath = os.getenv('FILEPATH')  # Example: infra/ansible/loadbalancer-haproxy/group_vars/all.yaml
token = os.getenv('TOKEN')  # GitHub token
external_label = os.getenv('EXTERNAL')  # Label key to check on Service
